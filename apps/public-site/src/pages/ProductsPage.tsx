...
const PRODUCTS: Product[] = [
  ...
  {
    id: "cashless-canteen",
    name: "Cashless Canteen",
    tagline: "School lunch payments without loose cash.",
    description:
      "Cashless Canteen is the public landing page for the school canteen workflow that connects Kids Wallet, NFC identity, and controlled student spending.",
    icon: <SmartphoneIcon className="h-6 w-6" />,
    iconBig: <SmartphoneIcon className="h-8 w-8" />,
    status: "live",
    audience: ["Schools", "Canteen Staff", "Parents", "Finance Teams"],
    features: [
      "Student wallet top-ups",
      "NFC tap at the counter",
      "Controlled spending limits",
      "Clear internal audit trail",
      "Works with School Connect NFC",
    ],
    ctaLabel: "Open Landing Page",
    ctaHref: "/cashless-canteen",
    secondaryLabel: "Learn NFC",
    secondaryHref: "/nfc",
    accentColor: "#0F5BD8",
    accentBg: "#EAF3FF",
  },
  {
    ...
    tagline: "One tap. Gate access, attendance, canteen wallets, and more.",
    description:
      "School Connect NFC gives every student an NFC wristband, card, or tag linked to their school profile. Staff tap it at gates, canteen counters, and attendance points to confirm identity, record attendance, process cashless payments, and trigger the right school workflow — with offline-ready scanning built in.",
    icon: <SparklesIcon className="h-6 w-6" />,
    iconBig: <SparklesIcon className="h-8 w-8" />,
    status: "live",
    audience: ["Schools", "Security Staff", "Canteen Staff", "Administration"],
    features: [
      "Gate access control and digital audit log",
      "Attendance tap-in and tap-out",
      "Cashless canteen via Kids Wallet",
      "Offline-ready scanning with auto-sync",
      "Role-based staff access (cashier, security, admin)",
      "Lost or deactivated wristband blocking",
    ],
    ctaLabel: "Learn About NFC",
    ctaHref: "/nfc",
  ...
  },
  {
    id: "stayos",
    name: "StayOS",
    tagline: "Property operations landing page for the RentFlow workflow.",
    description:
      "StayOS is the public keyword landing page for SSAMENJ's stay operations workflow. It points property teams to the RentFlow product for bookings, tenants, balances, cleaning, and statements.",
    ...
    features: [
      "Short-stay and rental workflows",
      "Bookings and tenant tracking",
      "Rent, deposit, and balance visibility",
      "Cleaning and maintenance follow-up",
    ],
    ctaLabel: "Open Landing Page",
    ctaHref: "/stayos",
    secondaryLabel: "Explore RentFlow",
    secondaryHref: "/rentflow",
    accentColor: "#0F5BD8",
    accentBg: "#EAF3FF",
  },
  {
          ...
          <div className="max-w-xl">
            ...
            <div className="mt-4 flex flex-wrap gap-1.5">
              {[
                ...
                { label: "Cashless Canteen", id: "cashless-canteen" },
                { label: "School Connect NFC", id: "nfc-bands" },
                { label: "StayOS", id: "stayos" },
