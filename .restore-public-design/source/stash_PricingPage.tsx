...
function ArrowRightIcon(props: SVGProps<SVGSVGElement>) {
  return <Icon {...props}><path d="M5 12h14" /><path d="m13 5 7 7-7 7" /></Icon>;
}
function SparkleIcon(props: SVGProps<SVGSVGElement>) {
  return <Icon {...props}><path d="M12 3l1.7 4.3L18 9l-4.3 1.7L12 15l-1.7-4.3L6 9l4.3-1.7L12 3Z" /></Icon>;
}
function CreditIcon(props: SVGProps<SVGSVGElement>) {
  return <Icon {...props}><rect x="2" y="5" width="20" height="14" rx="2" /><path d="M16 13a1 1 0 1 0 2 0 1 1 0 0 0-2 0ZM2 10h20" /></Icon>;
}
function DocumentIcon(props: SVGProps<SVGSVGElement>) {
  return <Icon {...props}><path d="M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8l-5-5Z" /><path d="M14 3v5h5M9 13h6M9 17h4" /></Icon>;
}
function GiftIcon(props: SVGProps<SVGSVGElement>) {
  return <Icon {...props}><path d="M20 12v10H4V12" /><path d="M22 7H2v5h20V7Z" /><path d="M12 22V7" /><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7Z" /><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7Z" /></Icon>;
}
function WrenchIcon(props: SVGProps<SVGSVGElement>) {
  return <Icon {...props}><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76Z" /></Icon>;
}
...
function SchoolPlanCard({
  ...
  return (
    <article
      className={[
        "group relative overflow-hidden rounded-2xl border bg-white p-5 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:shadow-xl flex flex-col",
    ...
    >
      ...
      />
      {highlighted && (
        <div className="absolute -right-8 top-4 w-20 h-20 rounded-full bg-blue-50/60 blur-2xl" />
      )}
        ...
        <div className="mt-4">
          {isCustom ? (
            ...
            <>
              ...
              <span className="text-xs text-slate-400 mt-0.5 block">per term</span>
            </>
          )}
        </div>
      ...
      <a
        ...
        rel="noreferrer"
        className={[
          "btn marketing-button-motion mt-5 w-full rounded-xl px-4 py-2.5 text-sm font-black text-center",
          highlighted
...
function CreditPackCard({
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-lg flex flex-col">
      ...
      <p className="mt-1 text-sm font-bold" style={{ color: "#0F5BD8" }}>{credits}</p>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="btn mt-4 w-full rounded-xl border border-blue-200 bg-white px-4 py-2 text-xs font-black text-blue-700 hover:bg-blue-50 text-center"
      >
        {cta}
      </a>
    </article>
  ...
  return (
    <div className="bg-slate-50 text-slate-950">
      <main>
        ...
        {/* ── Launch offer banner ── */}
        <div
          className="border-b px-4 py-2.5 sm:px-6 lg:px-8 text-center"
        ...
        >
          <p className="text-xs font-bold text-white flex items-center justify-center gap-2">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="underline underline-offset-2 hover:no-underline ml-1 whitespace-nowrap"
            >
              Claim offer →
            </a>
          </p>
          ...
          <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-12 lg:items-start">
            <div className="lg:col-span-7">
              ...
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-600">
                Start using School Connect Report Lab and Smart Pages for one academic term at no subscription cost.
                After the free term, continue with the plan that fits your school size and workflow.
              </p>
              <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="btn marketing-button-motion rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-4 py-3 text-sm font-black text-white shadow-lg shadow-blue-600/20 hover:shadow-xl hover:shadow-blue-600/25 text-center"
                >
                  Get Started Free
                </a>
                <a
                  href="/demos"
                  className="btn marketing-button-motion rounded-xl border border-blue-200 bg-white px-4 py-3 text-sm font-bold text-blue-700 shadow-sm hover:bg-blue-50 text-center"
                >
                  Watch Demo
                </a>
              </div>
              ...
              <div className="grid gap-4 lg:grid-cols-12 lg:items-center">
                <div className="lg:col-span-8">
                  ...
                  <p className="mt-1.5 text-sm text-slate-600">
                    For large schools, school groups, multi-campus networks, and institutions that need custom workflows, bulk pricing, or integration with existing systems.
                  </p>
                </div>
                <div className="lg:col-span-4 flex flex-col gap-2 lg:items-end">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="btn marketing-button-motion rounded-xl border border-slate-300 bg-white px-5 py-2.5 text-sm font-black text-slate-700 hover:border-blue-200 hover:bg-blue-50 hover:text-blue-700 text-center"
                  >
              ...
              <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
                {[
                  ...
                  <div key={row.action} className="rounded-xl border border-slate-100 bg-slate-50 p-3.5">
                    ...
                    <p className="mt-1 text-sm font-black" style={{ color: "#0F5BD8" }}>{row.cost}</p>
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                <div className="flex items-start gap-3">
                  <WrenchIcon className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                  <div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="btn marketing-button-motion mt-5 w-full rounded-xl border border-blue-200 bg-white px-4 py-2.5 text-sm font-black text-blue-700 hover:bg-blue-50 text-center"
                >
                  Request Setup
                </a>
              </div>
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="btn marketing-button-motion mt-4 inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-black text-white text-center"
