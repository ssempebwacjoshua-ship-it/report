...
function DemoCard({
  ...
  return (
    <button
      ...
      className={`w-full rounded-2xl border p-4 text-left transition ${buttonClassName}`}
    >
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="min-w-0">
              ...
              <h1 className="mt-1 text-3xl font-black tracking-tight text-slate-950">Features Demo</h1>
