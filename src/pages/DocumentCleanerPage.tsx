...
const MODES: Array<{ value: ExtractionMode; label: string; description: string }> = [
  { value: "economical", label: "Economical", description: "Basic OCR â€” best for simple lists" },
  { value: "balanced", label: "Balanced", description: "Layout-aware â€” best for tables and grids" },
  { value: "high_accuracy", label: "High Accuracy", description: "Form parser â€” higher cost, PRO/Enterprise only" },
];
    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-8">
      <div className="mx-auto max-w-4xl">
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          ...
          {/* Smart Pages card â€” always visible */}
          <div className={`shrink-0 rounded-lg border px-4 py-3 text-sm ${
            ...
            {spStatus === "loading" && (
              <>
                ...
                <p className="mt-0.5 text-gray-400">Loading Smart Pagesâ€¦</p>
              </>
            )}
          ...
          <>
            ...
            >
              ...
              <p className="mb-3 text-sm font-medium text-gray-700">
                {uploading ? "Extracting text from your documentâ€¦" : "Drag & drop a file here"}
              </p>
              {!uploading && (
                <button
                  type="button"
              ...
              <p className="mt-3 text-xs text-gray-400">PNG, JPG, WEBP, or PDF â€” max 20 MB</p>
              ...
              <p className="mt-3 text-xs text-gray-600">
                ...
                {(doc.cellCorrections?.length ?? 0) > 0 && (
                  <span className="text-amber-700">
                    ...
                    {doc.cellCorrections!.length !== 1 ? "s" : ""} auto-corrected â€” highlighted
