...
/**
 * Single source of truth for numeric mark validation (0â€“100 inclusive).
...
export function validateScore(raw: string | number | null | undefined): ScoreValidation {
  ...
  if (n < 0 || n > 100) return { valid: false, value: null, error: `Score ${n} is outside the allowed range (0â€“100).` };
